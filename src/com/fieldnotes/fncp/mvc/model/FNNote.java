...
/**
 * The <i>FNNote</i> class contains the data for a FieldNote entry into the DATA table of the database.
 */

public class FNNote extends FieldNote {
    ...
    private FNNote(final String userName, final String id, final String dateStart, final String dateEnd,
    ...
    public static class FieldNoteBuilder {
        ...
        public FieldNoteBuilder setUserName(String newUserName) {
            this.mNewName = newUserName;
            return this;
        }

        public FieldNoteBuilder setNoteId(String newId) {
            this.mId = newId;
            return this;
        }
        ...
        public FNNote build() {
            return new FNNote(mNewName, mId, mNewDateStart, mNewDateEnd, mNewTimeStart, mNewTimeEnd,
        ...
        public FNNote buildEmptyFieldNote() {
            return new FNNote(null, null, null, null, null,
