...
import com.devhunter.fieldnotes.mvc.controller.CrudSearchValidation;
...
public class EditDataPanel extends FNPanel {
	...
	// Panels
	public static EditDataPanel sInstance;
	...
	private JDatePanelImpl mEditTicketStartDatePanel;
	...
	private JDatePanelImpl mEditTicketEndDatePanel;
	...
	private EditDataPanel() {
		...
		mEditTicketStartDatePanel = new JDatePanelImpl(mEditTicketStartModel, mEditTicketStartProperties);
		...
		buttonEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(FieldNoteValidation.validate(fieldNote)) {
					...
					SQLDataController conn = new SQLDataController();
					int resultCode = conn.updateFieldNote(fieldNote, mFlexTicketNumber);
					...
					if (resultCode == 1) {
						...
						JOptionPane.showMessageDialog(FieldNotesControlPanel.getFieldNotesFrame(),
								"Connection Error - NOTE NOT UPDATED");
					}
				} else {
